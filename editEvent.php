            ...
            <form action="process_post.php" method="POST" enctype="multipart/form-data">
              ...
              <div class="mb-3">
                ...
                <select class="form-control form-control-lg custom-select" id="event_distance" name="event_distance"
                  ...
                  <option value="Half Marathon"
                    <?= ($event['event_distance'] === 'Half Marathon') ? 'selected' : ''; ?>>
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="event_image_url" name="event_image_url"
                  value="<?php if (isset($event['event_image_url']) && filter_var($event['event_image_url'], FILTER_VALIDATE_URL)) : ?><?= $event['event_image_url'] ?><?php endif; ?>">
              </div>

              <label for="event_image" class="form-label">Uploaded Cover Image</label>
              <div class="mb-3">
                <img
                  src="<?= empty($event['event_image_url']) || filter_var($event['event_image_url'], FILTER_VALIDATE_URL) ? 'assets/default/picture-not-available.jpg' : $event['event_image_url']  ?>"
                  alt="Event Cover" class="img-thumbnail" width="200">
